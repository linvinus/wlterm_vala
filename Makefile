...
VALA_FLAGS += --vapidir ./vapi --pkg libtsm -X -Iexternal/ --pkg shl_pty --pkg posix  --pkg gtk+-3.0 --pkg gdk-x11-3.0 --pkg cairo -X -lxkbcommon --pkg shm --pkg glib-2.0 --pkg gio-2.0 --pkg gio-unix-2.0
